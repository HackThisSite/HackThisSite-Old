...
<center>
	...
	<form action="<?php echo Url::format('missions/basic/1/index.php'); ?>" method="post">
	...
	<table border="0" width="80%" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td class="light-td">
				&nbsp;If you have no idea what to do, you must 
				<a href="http://www.w3schools.com/HTML">learn HTML</a>.
			</td>
		</tr>
	</table>
</center>
