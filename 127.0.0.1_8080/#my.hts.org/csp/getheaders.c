...
//            output we got from apache.org in 2009:
//
//            HTTP/1.1 200 OK
...
//
//            ...and it was slightly modified in 2011 (UTF-8, etc.):
//
//            HTTP/1.1 200 OK
//            Date: Sat, 06 Aug 2011 12:24:40 GMT
//            Server: Apache/2.3.8 (Unix) mod_ssl/2.3.8 OpenSSL/1.0.0c
//            Last-Modified: Mon, 25 Jul 2011 10:10:22 GMT
//            ETag: "f19837-86f4-4a8e205e7df80"
//            Accept-Ranges: bytes
//            Content-Length: 34548
//            Vary: Accept-Encoding
//            Cache-Control: max-age=3600
//            Expires: Sat, 06 Aug 2011 13:24:40 GMT
//            Connection: close
...
static char top[] = "<!DOCTYPE HTML>"
     ...
     "</head><body style=\"margin:0 16px;\"><h2>%s</h2><br>\r\n";
...
int main(int argc, char *argv[])
{
   ...
   // -------------------------------------------------------------------------
   char *pHost = "apache.org", *pURL = "/index.html";
   int port = 80;
   if(argc > 0)
   {
