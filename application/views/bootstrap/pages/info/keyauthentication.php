...
than ever, and keeps your account more secure than any password system out 
there.  HackThisSite's PKI is based off of the paper 
...
<p>Then you must paste the contents of <i>client.csr</i> into the <b>Request 
...
browser and login to HackThisSite by any of the methods described below.
</p><br />
...
<ol>
	...
	<em>Note:  This makes it impossible to logout!  Also, if this is your 
    only method of authentication, it makes it impossible for us to tell 
    you that you are banned.</em></li>
	...
	of two of the methods above.  Instead of using a blank login like 
