...
<?php } } $this->_tpl_include('forumlist_body.html'); if ($this->_tpldata['DEFINE']['.']['QUASAR_MENUPOSITION'] == ('full') || $this->_tpldata['DEFINE']['.']['QUASAR_MENUPOSITION'] == ('fluid')) {  if (! $this->_rootref['S_USER_LOGGED_IN'] && ! $this->_rootref['S_IS_BOT']) {  ?>
